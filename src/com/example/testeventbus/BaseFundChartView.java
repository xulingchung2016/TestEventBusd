...
//	        UIUtils.log("rewqfdesa",gridY,"fdsafdsa");
	        ...
	        //画X轴。
	        y = gridY;
	        canvas.drawLine(gridX, y , getWidthYMax(), y, linePaint);//X轴.
	        canvas.drawLine(getWidthYMax(), y , getWidthYMax() - 14, y - 6 , linePaint);//X轴箭头。
	        ...
	        if(dateX!=null){
	            ...
	            for (int n = 0; n < size; n+=step) {
	                ...
	                if (dateX.get(n) != null) {
	                    ...
	                    canvas.drawText(dateX.get(n), x, gridY + XTextPadding, textPaint);//X具体刻度值。
	                }
	            }
	        }
	        ...
	        if(lineX!=null){
	            /*if(text!=null&&text.size()>0){
	        	 ...
	        	 canvas.drawLine(lineX, gridY , lineX, 10, huodongPaint);
	  	        //画X轴。
	  	        canvas.drawLine(gridX, lineY, getWidthYMax(), lineY, huodongPaint);//X轴.
	        }
